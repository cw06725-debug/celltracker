...
class SettingsRepository(context: Context) {
    ...
    fun load(): AppSettings = AppSettings(
        ...
        floatingAutomationManualControls = prefs.getBoolean("floating_automation_manual_controls", false),
    ...
    fun save(settings: AppSettings) {
        prefs.edit()
            ...
            .putBoolean("floating_automation_manual_controls", settings.floatingAutomationManualControls)
